...
<!-- Hero Section -->
<section id="hero" class="hero section dark-background d-none d-md-flex" 
  style="background-image: url('admin/<?= htmlspecialchars($heroImage ?: 'assets/img/hero.png') ?>');">
  <div class="overlay"></div>
 
</section>
<!-- Mobile Hero Section: show full image and text below -->
<section class="d-block d-md-none" style="background: #fff; padding: 0; text-align: center;">
  <img src="admin/<?= htmlspecialchars($heroImage ?: 'assets/img/hero.png') ?>" alt="Banner" style="width:100%;height:auto;display:block;">
...
.category-circle-card {
  ...
  border-radius: 50%;
  background: #ffe066;
  box-shadow: 0 2px 16px rgba(214, 182, 105, 0.18);
  border: 5px solid #d1a94a;
  display: flex;
  flex-direction: column;
  align-items: center;
...
.category-circle-card:hover {
  box-shadow: 0 8px 32px rgba(214, 182, 105, 0.28);
        ...
        <div class="row">
          <div class="col-lg-4">
            ...
            <div class="fea-content text-center">
              ...
              <!-- <button class="btn btn-outline-dark px-5 rounded-3" style="pointer-events: none; opacity: 0.7;">View Collection</button> -->
            </div>
          </div>
          <div class="col-lg-4">
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 content d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="100">
            <p class="who-we-are text-center text-lg-start">About Our Traditional Sweets</p>
            <h3 class="text-center text-lg-start">Our Story</h3>
            <p class="para text-center text-lg-start">
              At Amit Dairy & Sweets, we blend tradition with taste to bring you the finest sweets and dairy products. Our journey is rooted in a passion for quality, purity, and customer delight. Experience the authentic flavors and heartfelt service that make us a trusted name for generations.
            </p>
            <a href="about" class="read-more mx-auto mx-lg-0"><span>Read More</span><i class="bi bi-arrow-right"></i></a>
          </div>
...
function submitToCart(productId, qty, boxId, modal) {
  ...
  .then(data => {
    ...
    if (trimmed === 'success') {
      showSuccess('Added to cart!', 'Product has been added to your cart successfully!');
      setTimeout(() => {
          location.reload();
      }, 2000);
      modal.hide();
  ...
  pincodeForm.addEventListener('submit', function (e) {
    ...
    .then(data => {
      if (data.status) {
        ...
        showError('Oops!', '🚫 We do not deliver to this pincode.');
    ...
    .catch(err => {
      ...
      showError('Error', 'Something went wrong while checking the pincode.');
    });
  });
