        ...
        <script>
          document.addEventListener('DOMContentLoaded', function() {
            Swal.fire({
              ...
              text: 'Please use a different number or login instead.',
...
document.getElementById('otpForm').addEventListener('submit', function(e) {
  ...
  if (otp.length !== inputs.length) {
    ...
    Swal.fire({
      ...
      text: 'Please enter the full OTP sent to your phone.',
    });
  }
});
  ...
  .then(data => {
    if (data.status === 'success') {
      Swal.fire({
        icon: 'success',
        title: 'OTP Resent!',
        text: `A new OTP has been sent to ${data.phone} (demo: ${data.otp})`,
        confirmButtonText: 'OK'
      });
    } else {
      Swal.fire({
