        ...
        <div class="cart-item" data-cart-key="<?= htmlspecialchars($cartKey) ?>">
          ...
          <div class="product-info">
            ...
            <div class="product-details">
              ...
              <a href="inc/remove_from_cart?key=<?= urlencode($cartKey) ?>" class="remove-link" onclick="return confirm('Remove this item?')">Remove</a>
            </div>
      </div>
...
<?php
            ...
            <div class="calculation-row">
              ...
              <span class="calculation-value">₹<?= number_format($subtotal, 2) ?></span>
        </div>
            ...
            <div class="mb-4">
              ...
              <div class="payment-methods">
                ...
                <div class="payment-option">
                  <input type="radio" class="btn-check" name="payment_method" id="cod_cart" value="cod" checked>
                  <label class="payment-method-card" for="cod_cart">
                ...
                <!-- Online Payment -->
                <div class="payment-option">
                  <input type="radio" class="btn-check" name="payment_method" id="online_cart" value="online">
                  <label class="payment-method-card" for="online_cart">
                    <div class="payment-icon">
                ...
                <!-- UPI Payment -->
                <div class="payment-option">
                  <input type="radio" class="btn-check" name="payment_method" id="upi_cart" value="upi">
                  <label class="payment-method-card" for="upi_cart">
                    <div class="payment-icon">
                ...
                <!-- Net Banking -->
                <div class="payment-option">
                  <input type="radio" class="btn-check" name="payment_method" id="netbanking_cart" value="netbanking">
                  <label class="payment-method-card" for="netbanking_cart">
                    <div class="payment-icon">
                ...
                <!-- Bank Transfer -->
                <div class="payment-option">
                  <input type="radio" class="btn-check" name="payment_method" id="banktransfer_cart" value="banktransfer">
                  <label class="payment-method-card" for="banktransfer_cart">
                    <div class="payment-icon">
                ...
                <!-- Wallet Payment -->
                <div class="payment-option">
                  <input type="radio" class="btn-check" name="payment_method" id="wallet_cart" value="wallet">
                  <label class="payment-method-card" for="wallet_cart">
                    <div class="payment-icon">
