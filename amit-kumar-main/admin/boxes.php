...
echo '<div style="background:yellow;color:black;z-index:9999;position:relative;">';
...
echo '<div style="background:orange;color:black;z-index:9999;position:relative;">';
echo 'Boxes found: ' . count($boxes) . '<br>';
echo '</div>';
?>
