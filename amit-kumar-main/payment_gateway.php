            ...
            switch (currentMethod) {
                case 'card':
                    ...
                    if (!expiryDate || expiryDate.length < 5) {
                        Swal.fire('Error', 'Please enter expiry date (MM/YY)', 'error');
                        return false;
                    }
                    if (!cvv || cvv.length < 3) {
                ...
                case 'upi':
                    ...
                    if (!upiId.trim()) {
                        Swal.fire('Error', 'Please enter UPI ID or scan QR code', 'error');
                        return false;
                    }
                    break;
                ...
                case 'netbanking':
                    ...
                    if (!bankSelect) {
                        Swal.fire('Error', 'Please select your bank', 'error');
                        return false;
                    }
                    break;
        ...
        function initializeQRScanner() {
            ...
            html5QrcodeScanner.render((decodedText) => {
                ...
                if (decodedText.includes('upi://')) {
                    ...
                    Swal.fire('Success', 'UPI ID scanned successfully!', 'success');
                } else {
                    Swal.fire('Error', 'Invalid UPI QR code', 'error');
                }
            }, (error) => {
                // Handle scan error
                console.log(error);
