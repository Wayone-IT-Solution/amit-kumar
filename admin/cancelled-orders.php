                    ...
                    <div class="table-responsive table-card mt-3 mb-1">
                        <table class="table align-middle table-nowrap" id="orderTable">
                            ...
                            <tbody class="list form-check-all">
                                <?php
                                require '../inc/db.php';
                                $stmt = $conn->prepare("SELECT * FROM orders WHERE order_status = 'cancelled' ORDER BY id DESC");
                                $stmt->execute();
                                ...
                                foreach ($orders as $order) {
                                    ...
                                    $cartSummary = '';
                                    $cartDataRaw = $order['cart_data'] ?? null; // cart_data from DB
                                    ...
                                    if (is_array($cartItems)) {
                                        ...
                                        $cartSummary = '<div class="text-danger">Cart data not available or invalid.</div>';
                                    }
                                    ?>
                                    <tr>
                                        <td><?= $sn++; ?></td>
