                                                ...
                                                <tr>
                                                   ...
                                                   <td class="total">
                                                      ...
                                                      <?php
                                                         ...
                                                         ?>
                                                      <?php foreach ($boxNames as $box): ?>
                                                      <span style="display:inline-block; margin-right:8px;">
                                                      <?php if (!empty($box['img'])): ?>
                                                      <img src="<?= htmlspecialchars($box['img']) ?>" alt="Box Image" style="max-width:100px; max-height:100px;" >
                                                      <?php else: ?>
                                                      <span style="display:inline-block; width:40px; height:40px; background:#eee; border-radius:4px; vertical-align:middle;"></span>
                                                      <?php endif; ?>
                                                      <span style="vertical-align:middle; margin-left:4px; font-weight:600;">
                                                      <?= (int)$box['qty'] ?> Box<?= $box['qty'] > 1 ? 'es' : '' ?>
                                                      </span>
                                                      </span>
                                                      <?php endforeach; ?>
                                                   </td>
